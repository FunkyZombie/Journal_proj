...
class CreatePostActionTest extends TestCase
{
    ...
    public function testItReturnsSuccessfulResponse(): void
    {
        ...
        $action = new CreatePost($postRepository, $userRepository, $this->JsonBodyUuidIdentification($userRepository), new DummyLogger());
    ...
    public function testItReturnsErrorResponseIfNotFoundUser(): void
    {
        ...
        $action = new CreatePost($postRepository, $usersRepository, $this->JsonBodyUuidIdentification($usersRepository), new DummyLogger());
